...
RUN apt-get update -qq && apt-get install -y nodejs postgresql-client yarn cron vim
...
RUN mkdir /self_analytics
WORKDIR /self_analytics
COPY Gemfile /self_analytics/Gemfile
